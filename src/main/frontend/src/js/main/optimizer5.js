...
$(document).ready(function() {
    $('.t_menu').mouseenter(function(e) {
        $(this).children('.t_view').fadeIn(0);
    }).mouseleave(function(e) {
        $(this).children('.t_view').fadeOut(0);
    });
});

/* 검색 */
$(document).ready(function() {
    $('.search_btn_on').click(function(e) {
        $('.t_view_search').fadeIn(0);
        $('.search_btn_off').fadeIn(0);
        $('.search_btn_on').fadeOut(0);
        $('#header').addClass("header_over");
    });
});
$(document).ready(function() {
    $('.search_btn_off').click(function(e) {
        $('.t_view_search').fadeOut(0);
        $('.search_btn_on').fadeIn(0);
        $('.search_btn_off').fadeOut(0);
...
$(document).ready(function() {
    $('.t_menu').mouseenter(function(e) {
        $(this).children('.t_view_multi').fadeIn(0);
    }).mouseleave(function(e) {
        $(this).children('.t_view_multi').fadeOut(0);
    });
});
...
/* 전체보기 메뉴 */
$(document).ready(function() {
    $('.full_btn').click(function(e) {
         $('.full_menu').fadeIn(0);
         $(this).hide( );
         $('.full_btn_plus').fadeIn(0);
         $('.full_btn_close').fadeIn(0);
         $('#header').addClass("header_over2");
    });
});

$(document).ready(function() {
    $('.full_btn_close').click(function(e) {
         $('.full_menu').hide(0);
         $(this).hide( );
         $('.full_btn').fadeIn(0);
         $('.full_btn_plus').hide( );
         $('#header').removeClass("header_over2");
    });
});

$(document).ready(function() {
    $('.full_btn_plus').click(function(e) {
         $('.full_menu').hide(0);
         $(this).hide( );
         $('.full_btn').fadeIn(0);
         $('.full_btn_plus').hide( );
...
$('#header').scrollToFixed( {
	marginTop: 0,
	//limit: $('#tabProduct').offset().top,
    //preFixed: function() { $(this).addClass('smaller'); //$('.header_inner').addClass('header_inner_fix'); },
    //postFixed: function() { $(this).removeClass('smaller'); }
    
    //preFixed: function() { $('.logo_vr').addClass('displaynone'); },
    //postFixed: function() { $('.logo_vr').removeClass('displaynone'); }
    
});

//$('.shop_category').scrollToFixed();
//$('.bbs_top_menu').scrollToFixed();
